...
def foodHeuristic(state, problem):
   ...
   # "nonvisited" chứa tọa độ của các địa điểm thực phẩm chưa được truy cập
    ...
    # "distances" là để lưu trữ khoảng cách Manhattan giữa vị trí hiện tại và từng vị trí thực phẩm
    distances = []
    ...
    # khoảng cách Manhattan giữa vị trí hiện tại và vị trí thực phẩm gần nhất được thêm vào heuristic
